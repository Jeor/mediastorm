...
func TestHomeDesignerTemplateProvidesAccessibleEditorStructure(t *testing.T) {
	...
	for _, marker := range []string{
		...
		`aria-controls="homeDesignerLibrary"`,
		`aria-controls="homeDesignerInspector"`,
		`aria-controls="homeDesignerTheme"`,
		`aria-label="Row library"`,
		`data-home-designer-canvas aria-label="Home row canvas"`,
		`aria-label="Row inspector"`,
		`class="home-designer-context-drawer" aria-label="Home Designer controls"`,
		`id="homeDesignerTheme" data-home-designer-theme aria-label="Theme editor"`,
