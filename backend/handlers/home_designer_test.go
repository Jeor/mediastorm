...
func TestHomeDesignerPageRendersForAdminAndAccount(t *testing.T) {
	...
	for _, test := range []struct {
		...
		t.Run(test.name, func(t *testing.T) {
			...
			for _, marker := range []string{"Home Designer", test.want, `data-home-designer-status`, "/assets/home-designer/app.js", `class="form-select" data-home-designer-scope`, `data-home-designer-theme></div>`} {
