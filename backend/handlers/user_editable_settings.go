...
var userEditableFields = map[string]map[string]struct{}{
	...
	"display": fieldSet(
		...
		"moveDetailsRatingsToMetadata", "hideDetailsPoster", "hideTvDrawerRail", "simpleMode", "simpleModeHomeShelves", "disableTvHomeCardDimming", "bypassFilteringForAioStreamsOnly",
...
var deviceEditableFields = map[string]map[string]struct{}{
	...
	"display":          fieldSet("navigationTabVisibility", "includeUnreleasedMoviesInLists", "includeUnreleasedShowsInLists", "includeUnreleasedMoviesInSearch", "includeUnreleasedShowsInSearch", "bypassFilteringForAioStreamsOnly", "disableMobileTopCarousel", "hideContinueWatchingHeroMetadata", "moveDetailsRatingsToMetadata", "hideDetailsPoster", "hideTvDrawerRail", "simpleMode", "simpleModeHomeShelves", "disableTvHomeCardDimming", "enableAnimations", "enableHeroArtPanning", "enableHeroArtRotation", "showSeriesBackdropForMissingEpisodeArt", "blurUnwatchedEpisodeThumbnails", "blurUnwatchedEpisodeThumbnailsIncludeCurrent", "blurUnwatchedEpisodeOverviews", "blurUnwatchedEpisodeOverviewsIncludeCurrent"),
	"network":          nil,
}
