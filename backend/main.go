...
func main() {
	...
	r.HandleFunc("/admin/assets/home-designer/{version:[A-Za-z0-9_.-]+}/{asset:[A-Za-z0-9_.-]+}", adminUIHandler.RequireAuth(handlers.HomeDesignerAsset)).Methods(http.MethodGet)
	...
	r.HandleFunc("/account/assets/home-designer/{version:[A-Za-z0-9_.-]+}/{asset:[A-Za-z0-9_.-]+}", adminUIHandler.RequireAuth(handlers.HomeDesignerAsset)).Methods(http.MethodGet)
